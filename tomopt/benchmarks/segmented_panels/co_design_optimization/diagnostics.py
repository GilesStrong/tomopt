...
class DiagnosticPlotter:
    ...
    def plot_signal_detection(self, plot_data: PlotData, tau_detect: float) -> None:
        ...
        sigmoid_curve = 1 / (1 + np.exp(-tau_detect * (jsd_grid - data["Tc_norm"][0])))
    ...
    def plot_all(self, plot_data: PlotData, tau_detect: float) -> None:
